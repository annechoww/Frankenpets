...
public class RoombaMovement : MonoBehaviour
{
    ...
    void Start()
    {
        if (boundary == null)
        {
            Debug.LogError("No boundary detected for Roomba");
            return;
        }

        // Initialize a random direction on the X-Z plane
    ...
    void CheckBounds()
    {
        ...
        // Check if Roomba is out of bounds
